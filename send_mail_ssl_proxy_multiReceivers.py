#!/usr/bin/env python3
# send_mail_ssl_proxy_multiReceivers.py
"""
.SYNOPSIS
Envia un correo con SSL detrás de un proxy HTTP a multiples destinatarios cuyas direcciones
están en un fichero CSV.

.DESCRIPTION
Envia un correo con SSL detrás de un proxy HTTP a multiples destinatarios cuyas direcciones
están en un fichero CSV, para ello usa las librerias estandar de Python "csv", "smtplib" y "ssl". 
...
.EXAMPLE
python3 send_mail_ssl_proxy_multiReceivers.py
...
sender_email = "usuario@gmail.com"  # Dirección del Remitente.
